...
pub const BUILTIN_NAMES: &[&str] = &[
    ...
    "__cffile_upload", "__cfflush", "__cfheader", "__cfhtmlbody", "__cfhtmlhead", "__cfinvoke",
    "__cflocation",
    ...
    "cachegetproperties", "cachekeyexists", "cacheput", "canonicalize", "ceiling", "cfadmin",
    "cfdbinfo",
    ...
    "lsparsedatetime", "lsparsenumber", "lstimeformat", "lsweek", "ltrim", "max",
    "mcp", "mcpaudio", "mcpclient", "mcpconnect", "mcpimage", "mcpnotify", "mcpresource",
    "mcpresourcelink", "mcpsessions", "mcptext", "metaphone",
    ...
    "queryaddcolumn", "queryaddrow", "queryappend", "queryclear", "querycolumnarray", "querycolumncount",
...
pub const VM_INTERCEPTED: &[&str] = &[
    "$siobroadcast", "$siodisconnect", "$siogetdata", "$siojoinroom", "$sioleaveallrooms",
    "$sioleaveroom", "$sioregisterednamespaces", "$sioregisternamespace", "$sioregisternshandler",
    "$sioregistersockethandler", "$siosend", "$siosetdata", "$siosocketcount", "__cfabort", "__cfadmin",
    ...
    "__cfexecute", "__cfexit", "__cffile_upload", "__cfflush", "__cfheader", "__cfhtmlbody",
    "__cfhtmlhead",
    ...
    "cfabort", "cfadmin", "cfcache", "cfcatch", "cfcontent", "cfcookie", "cfdbinfo", "cfdirectory",
    "cfdocument", "cfdump", "cfexecute", "cffile", "cfflush", "cfheader", "cfhtmlbody",
    "cfhtmlhead",
    ...
    "io", "isdebugmode", "isdefined", "isflushed", "isinthread", "isuserinrole",
    "isuserloggedin", "json",
